 ...
 */
static void gdt_set_entry(int num, unsigned long long base, unsigned long limit,
 ...
 */
static void gdt_set_tss(int num, unsigned long long base, unsigned long limit) {
    // Base address
    gdt[num].base_low = base & 0xFFFF;
    gdt[num].base_middle = (base >> 16) & 0xFF;
    gdt[num].base_high = (base >> 24) & 0xFF;
